...
bool Tests::TriangleGetterHeighta() {
	triangle::Triangle* triangle = new triangle::Triangle;
	triangle->heighta = 4;
...
bool Tests::TriangleGetterHeightb() {
	triangle::Triangle* triangle = new triangle::Triangle;
	triangle->heightb = 5;
...
bool Tests::TriangleGetterHeightc() {
	triangle::Triangle* triangle = new triangle::Triangle;
	triangle->heightc = 6;
...
bool Tests::Trianglefindheighta() {
	triangle::Triangle* triangle = new triangle::Triangle;
	triangle->angleB = 63;
	triangle->angleC = 29;
	triangle->sidea = 4;
...
bool Tests::Trianglefindheightb() {
	triangle::Triangle* triangle = new triangle::Triangle;
	triangle->angleA = 34;
	triangle->angleC = 29;
	triangle->sideb = 3;
...
bool Tests::Trianglefindheightc() {
	triangle::Triangle* triangle = new triangle::Triangle;
	triangle->angleA = 34;
	triangle->angleB = 29;
	triangle->sidec = 3;
...
bool Tests::Rectanglegetperimeter() {
	rectangle::Rectangle* rec = new rectangle::Rectangle;
	rec->length = 2;
	rec->width = 3;
	bool output = (6 <= rec->getrectanglearea());
